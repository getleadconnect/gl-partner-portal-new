        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="{{ route('agent.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
					<i class='bx bx-log-out text-muted font-size-18 align-middle me-1'></i> 
					<span class="align-middle">Logout</span></a>
					<form action="{{ route('agent.logout') }}" id="logout-form" method="post">@csrf</form>
                </div>
            </div>
        </div>
    </div>
    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('agent.partners')}}" >
                        <i class="bx bx-user-circle icon nav-icon"></i>
                        <span class="menu-item" data-key="t-partners">My Partners</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('agent.create-lead')}}">
                        <i class="bx bx-cog icon nav-icon"></i>
                        <span class="menu-item" data-key="t-settings">Leads</span>
                    </a>
                </li>
            </ul>
        </div>
