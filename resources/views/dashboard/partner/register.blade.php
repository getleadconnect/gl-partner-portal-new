    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4" style="margin-top: 45px">
                 <h4>Partner Register</h4><hr>
                 <form action="{{ route('partner.create') }}" method="post" autocomplete="off" >
                    ...
                    <div class="form-group">
                     ...
                     <br>
                     <a href="{{ route('partner.login') }}">I already have an account, Login now</a>
                 </form>
            </div>
        </div>
    </div>
