            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto gsign-up"
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    <div class="login-form login-signin main-login">
                        <form class="form"  method="POST" action="{{ route('partner.check-forgot-password-otp')}}" novalidate="novalidate">
						@csrf
                        ...
                        <div class="already mt-3" style="float: none;">Didn't receive OTP?
						<a href="javascript:;" id="resendOtp" data-email="{{$user_email}}">Resend</a> 
						</div> 
...
$("#resendOtp").click(function()
{
	...
	$.ajax({
		url: "{{ url('partner/resend-forgot-password-otp')}}"+"/"+email,
		type: 'get',
