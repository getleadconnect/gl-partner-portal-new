            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto gsign-up"
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    <div class="login-form login-signin main-login">
                        ...
                        <form  method="POST" id="login-form" action="{{ route('partner.check') }}" >
						@csrf
                            ...
                            <div class="help text-center pt-4">Don't have an account?<a href="{{route('partner.signup')}}"> Register now</a></div>
                        </form>
	...
	<script src="{{asset('assets/sweetalert2/sweetalert2.min.js')}}"></script>
	 ...
	 @if(Session::get('success'))
        <script>
			...
			toastr.success("Registration successfull, You can login now !!!");
        </script>
        @endif
