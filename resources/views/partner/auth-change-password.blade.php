            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto gsign-up"
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    <div class="login-form login-signin main-login">
                        <form class="form" method="post" action="{{route('partner.update-user-password')}}" novalidate="novalidate">
						@csrf
                            ...
                            <div class="form-group">
								...
								<div style="position:relative;">
                                  <input class="form-control form-control-solid h-auto" type="password"
                                    placeholder="Type your password here" name="new_password" id="new_password" minlength=6 maxlength=30 autocomplete="off" required />
									<span id="toggle_pwd" class="fa fa-fw login-icon-eye fa-eye mt-5"></span>
								</div>
							...
							<div class="form-group">
								...
								<div style="position:relative;">
                                  <input class="form-control form-control-solid h-auto" type="password"
									...
									<span id="conf_toggle_pwd" class="fa fa-fw login-icon-eye fa-eye mt-5"></span>
								</div>
