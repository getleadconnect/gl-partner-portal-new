            ...
            <form class="kt-form kt-form--label-right" id="lead-form">
                ...
                <div class="row modal-body">
                    ...
                    <div class="col-md-3 form-group">
                        <label for="recipient-name" class="form-control-label">Mobile Number<span
                                style="color: red;">*</span></label>
                        <input type="number" class="form-control first_number" placeholder="Mobile Number"
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="number" class="form-control second_number" placeholder="Alernative Number"
                            value="{{ old('mobile') }}" name="mobile_optional" id="mobile_optional" pattern="[1-9]{1}[0-9]{9}">
                            <label id="mobile-optional-error1" class="hidden err" for="mobile">Please enter a different number</label>
                            <label id="mobile-optional-error2" class="hidden err" for="mobile">Please enter atleast 10 digits or leave this field blank</label>
                    </div>
                    <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {!! Form::select('partner_id', $partner_list, null, ['class' => 'form-control selectpicker','data-live-search'=>'true','id'=>'partner_id','title'=>'Select Partner']) !!}
                    </div>
                    <div class="col-md-6 form-group">
        ...
        <div class="modal-content">
            ...
            <form class="kt-form kt-form--label-right" id="edit-lead-form">
                ...
                <div class="row modal-body">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="recipient-name" class="form-control-label">Select Partner</label>
                        {!! Form::select('partner_id', $partner_list, null, ['class' => 'form-control selectpicker','data-live-search'=>'true','id'=>'edit_partner_id']) !!}
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="recipient-name" class="form-control-label">Lead Type</label>
                    ...
                    <div class="col-md-6 form-group">
                        <label for="recipient-name" class="form-control-label">Lead Purpose</label>
                        {!! Form::select('edit_lead_purpose[]', $products, null, ['class' => 'form-control selectpicker','multiple','title'=>'Select Lead Purpose','required','id'=>'edit_lead_purpose']) !!}
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" id="cancel_action"
                        data-dismiss="modal">Close</button>
                    <button type="button" id="update_lead" class="btn btn-success">Update</button>
                </div>
            </form>
        </div>
    </div>
