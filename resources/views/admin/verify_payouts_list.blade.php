        ...
        <div class="container-fluid">
            ...
            <div class="gl-page-header">
                <div class="gl-page-header__text">
                    <h1 class="gl-page-title">Verify Payouts</h1>
                    <div class="gl-page-subtitle">Review and verify partner payouts before they are released.</div>
                </div>
