        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-2 border-top d-grid">
                        <a class="btn btn-sm btn-link font-size-14 btn-block text-center" href="{{ url('admin/notifications')}}">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                   <!-- <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#change-password-modal"><i class='bx bx-lock text-muted font-size-18 align-middle me-1'></i> <span class="align-middle">Change Password</span></a>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
				 ...
				 <li>
                    <a href="{{ route('admin.agents')}}">
                        ...
                        <span class="menu-item" data-key="t-payouts">Agents</span>
                    </a>
                </li>
				...
				<li>
                    <a href="{{ route('admin.payout-history')}}">
                        <i class="bx bx-wallet icon nav-icon"></i>
                        <span class="menu-item" data-key="t-payouts">Payout History</span>
                    </a>
                </li>
               ...
               <!-- <li>
                ...
                <!--<li>
                    <a href="{{ route('admin.developer-api')}}">
				...
				<li>
                    <a href="{{ route('admin.notification-settings')}}">
                        <i class="bx bx-bell icon nav-icon"></i>
                        <span class="menu-item" data-key="t-notifications">Notification Settings</span>
                    </a>
                </li>
				...
				<!--<li>
                    <a href="{{ url('/notification-manager/config')}}" target="_blank">
                        <i class="bx bx-cog icon nav-icon"></i>
                        <span class="menu-item" data-key="t-settings">Settings</span>
                    </a>
                </li>-->
...
{
	$.ajax({
		url: "{{ route('admin.get-latest-notifications')}}",
		type: 'get',
		//data: 
...
{
	$.ajax({
		url: "{{ route('admin.set-notifications-as-read')}}",
		type: 'get',
		//data: 
		success: function(res)
		{
