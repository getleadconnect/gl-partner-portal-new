! function() {
    ...
    function o(a) {
        document.querySelectorAll(".header-lang-img").forEach(function(t) {
            if (t) {
                ...
                localStorage.setItem("language", a), null == (n = localStorage.getItem("language")) && o(s), (e = new XMLHttpRequest).open("GET", "/assets/lang/" + n + ".json"), e.onreadystatechange = function() {
                    var a;
    ...
    }, i(), document.addEventListener("DOMContentLoaded", function(t) {
        document.getElementById("side-menu") && new MetisMenu("#side-menu")
    }), t();
	
	/*for (var r, c, u, m = document.body.getAttribute("data-sidebar-size"), b = (window.onload = function() {
            1024 <= window.innerWidth && window.innerWidth <= 1366 && (document.body.setAttribute("data-sidebar-size", "sm"), d("sidebar-size-small"))
        }, 
		document.getElementsByClassName("vertical-menu-btn")), y = 0; y < b.length; y++) b[r = y] && b[r].addEventListener("click", function(t) {
    ...
    for (var r, c, u, m = document.body.getAttribute("data-sidebar-size"), b = (window.onload = function() {
            1024 <= window.innerWidth && window.innerWidth <= 1366 && (document.body.setAttribute("data-sidebar-size", "lg"), d("sidebar-size-small"))
        }, 
		document.getElementsByClassName("vertical-menu-btn")), y = 0; y < b.length; y++) b[r = y] && b[r].addEventListener("click", function(t) {
        t.preventDefault(), document.body.classList.toggle("sidebar-enable"), 992 <= window.innerWidth ? null == m ? null == document.body.getAttribute("data-sidebar-size") || "lg" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "lg") : "md" == m ? "md" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "sm") : document.body.setAttribute("data-sidebar-size", "md") : "sm" == document.body.getAttribute("data-sidebar-size") ? document.body.setAttribute("data-sidebar-size", "lg") : document.body.setAttribute("data-sidebar-size", "sm") : e()   
		});
    ...
    }), "null" != n && n !== s && o(n), (u = document.querySelectorAll(".language")) && u.forEach(function(e) {
        e.addEventListener("click", function(t) {
            o(e.getAttribute("data-lang"))
        })
    }), document.getElementById("layout-width-boxed").addEventListener("click", function() {
        d("sidebar-size-small"), document.body.setAttribute("data-sidebar-size", "sm")
    }), c = document.getElementsByTagName("body")[0], (u = document.querySelectorAll(".light-dark")) && u.forEach(function(t) {
        t.addEventListener("click", function(t) {
            c.hasAttribute("data-bs-theme") && "dark" == c.getAttribute("data-bs-theme") ? (d(".layout-mode-light"), document.body.setAttribute("data-bs-theme", "light"), "vertical" == document.body.getAttribute("data-layout") && document.body.setAttribute("data-topbar", "light")) : (d(".layout-mode-dark"), document.body.setAttribute("data-bs-theme", "dark"), "vertical" == document.body.getAttribute("data-layout") && document.body.setAttribute("data-topbar", "dark"))
        })
    }), c = document.body, document.getElementById("right-bar-toggle").addEventListener("click", function(t) {
    ...
    }), (c = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout") ? (d("layout-horizontal"), document.getElementById("sidebar-setting").style.display = "none", document.getElementsByClassName("vertical-menu")[0].style.display = "none", document.getElementsByClassName("ishorizontal-topbar")[0].style.display = "block", document.getElementsByClassName("isvertical-topbar")[0].style.display = "none") : (d("layout-vertical"), document.getElementById("sidebar-setting").style.display = "block", document.getElementsByClassName("vertical-menu")[0].style.display = "block", document.getElementsByClassName("ishorizontal-topbar")[0].style.display = "none"), c.hasAttribute("data-bs-theme") && "dark" == c.getAttribute("data-bs-theme") ? d("layout-mode-dark") : d("layout-mode-light"), c.hasAttribute("data-layout-size") && "boxed" == c.getAttribute("data-layout-size") ? d("layout-width-boxed") : d("layout-width-fluid"), c.hasAttribute("data-layout-scrollable") && "true" == c.getAttribute("data-layout-scrollable") ? d("layout-position-scrollable") : d("layout-position-fixed"), c.hasAttribute("data-topbar") && "dark" == c.getAttribute("data-topbar") ? d("topbar-color-dark") : d("topbar-color-light"), c.hasAttribute("data-sidebar-size") && "sm" == c.getAttribute("data-sidebar-size") ? d("sidebar-size-small") : c.hasAttribute("data-sidebar-size") && "md" == c.getAttribute("data-sidebar-size") ? d("sidebar-size-compact") : d("sidebar-size-default"), c.hasAttribute("data-sidebar") && "brand" == c.getAttribute("data-sidebar") ? d("sidebar-color-brand") : c.hasAttribute("data-sidebar") && "dark" == c.getAttribute("data-sidebar") ? d("sidebar-color-dark") : d("sidebar-color-light"), document.getElementsByTagName("html")[0].hasAttribute("dir") && "rtl" == document.getElementsByTagName("html")[0].getAttribute("dir") ? d("layout-direction-rtl") : d("layout-direction-ltr"), document.querySelectorAll("input[name='layout'").forEach(function(t) {
        t.addEventListener("change", function(t) {
            t && t.target && "vertical" == t.target.value ? (d("layout-vertical"), document.body.setAttribute("data-layout", "vertical"), document.body.setAttribute("data-sidebar", "dark"), document.body.setAttribute("data-topbar", "light"), document.getElementById("sidebar-setting").style.display = "block", document.getElementsByClassName("isvertical-topbar")[0].style.display = "block", document.getElementsByClassName("ishorizontal-topbar")[0].style.display = "none", document.getElementsByClassName("vertical-menu")[0].style.display = "block", window.innerWidth <= 992 && document.getElementsByClassName("vertical-menu")[0].removeAttribute("style"), d("sidebar-color-dark"), d("topbar-color-light")) : (d("layout-horizontal"), document.body.setAttribute("data-layout", "horizontal"), document.body.removeAttribute("data-sidebar"), document.body.setAttribute("data-topbar", "dark"), document.getElementById("sidebar-setting").style.display = "none", document.getElementsByClassName("vertical-menu")[0].style.display = "none", document.getElementsByClassName("ishorizontal-topbar")[0].style.display = "block")
        })
    }), document.querySelectorAll("input[name='layout-mode']").forEach(function(t) {
        t.addEventListener("change", function(t) {
            t && t.target && t.target.value && ("light" == t.target.value ? (document.body.setAttribute("data-bs-theme", "light"), document.body.setAttribute("data-topbar", "light"), document.body.setAttribute("data-sidebar", "dark"), c.hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout") && document.body.removeAttribute("data-sidebar"), d("topbar-color-light")) : (document.body.setAttribute("data-bs-theme", "dark"), document.body.setAttribute("data-topbar", "dark"), document.body.setAttribute("data-sidebar", "dark"), c.hasAttribute("data-layout") && "horizontal" == c.getAttribute("data-layout") || d("topbar-color-dark")), d("sidebar-color-dark"))
        })
