...
class Partner extends Authenticatable
{
    ...
    protected $fillable = [ 
		'unique_id','name','email','partner_tier_id','country_code','mobile','company_name','password','website','commission_percentage','renewal_comm_percentage',
		'team_size','country','country_name','state','state_name','city','pin_code','email_verified_at','password','agent_id','photo','bank_name',
